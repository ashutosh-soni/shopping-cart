...
describe("Step 1: Add products to the shopping cart.", ()=>{
    ...
    describe("When", () =>{
        ...
        it("And then adds 2 Axe Deos to the shopping cart", () =>{
    ...
    describe("Then", () =>{
        ...
        it("The shopping cart should contain 2 Axe Deos each with a unit price of 99.99", () =>{
            expect(shoppingCart.getTotalItemsById("axeDeo")).to.equal(2);
        });

        it("And the total sales tax amount for the shopping cart should equals 35.00", () =>{
